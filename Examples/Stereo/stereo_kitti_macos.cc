...
// macOS ARM64 version with proper threading for Pangolin viewer
...
int main(int argc, char **argv)
{
    if(argc != 4)
    {
        cerr << endl << "Usage: ./stereo_kitti_macos path_to_vocabulary path_to_settings path_to_sequence" << endl;
        return 1;
    }
    ...
    // This is required because macOS requires OpenGL contexts to be created in the main thread
